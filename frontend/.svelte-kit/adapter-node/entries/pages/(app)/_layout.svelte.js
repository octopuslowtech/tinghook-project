...
import { U as sanitize_props, V as spread_props, W as slot, X as attr_class, Y as ensure_array_like, Z as stringify, _ as store_get, $ as unsubscribe_stores, a0 as bind_props } from "../../../chunks/index2.js";
...
function Sidebar($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    const navItems = [
      ...
      { href: "/logs", label: "Message Logs", icon: File_text },
      { href: "/settings", label: "Settings", icon: Settings }
    ];
    $$renderer2.push(`<aside${attr_class(`fixed inset-y-0 left-0 z-50 w-64 transform bg-gray-900 text-white transition-transform lg:translate-x-0 ${stringify(open ? "translate-x-0" : "-translate-x-full")}`)}><div class="p-6"><h1 class="text-2xl font-bold">TingHook</h1></div> <nav class="mt-6"><!--[-->`);
    const each_array = ensure_array_like(navItems);
    for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
      let item = each_array[$$index];
      $$renderer2.push(`<a${attr("href", item.href)}${attr_class(`flex items-center px-6 py-3 transition-colors hover:bg-gray-800 ${stringify(store_get($$store_subs ??= {}, "$page", page).url.pathname === item.href ? "border-l-4 border-blue-500 bg-gray-800" : "")}`)}><!---->`);
      item.icon($$renderer2, { class: "mr-3 h-5 w-5" });
      $$renderer2.push(`<!----> ${escape_html(item.label)}</a>`);
    }
    $$renderer2.push(`<!--]--></nav> <div class="absolute bottom-0 w-full p-6"><button class="flex items-center text-gray-400 hover:text-white">`);
    Log_out($$renderer2, { class: "mr-3 h-5 w-5" });
    $$renderer2.push(`<!----> Logout</button></div></aside>`);
...
function ConnectionStatus($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    if (store_get($$store_subs ??= {}, "$wsStore", wsStore).connected) {
      $$renderer2.push("<!--[-->");
      Wifi($$renderer2, { class: "h-4 w-4 text-green-500" });
      $$renderer2.push(`<!----> <span class="text-green-600">Connected</span>`);
    } else {
      $$renderer2.push("<!--[!-->");
      Wifi_off($$renderer2, { class: "h-4 w-4 text-red-500" });
      $$renderer2.push(`<!----> <span class="text-red-600">Disconnected</span>`);
    }
    $$renderer2.push(`<!--]--></div>`);
    if ($$store_subs) unsubscribe_stores($$store_subs);
  });
...
function Header($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    var $$store_subs;
    $$renderer2.push(`<header class="flex items-center justify-between border-b bg-white px-6 py-4"><button class="lg:hidden">`);
    Menu($$renderer2, { class: "h-6 w-6" });
    $$renderer2.push(`<!----></button> <div class="flex-1"></div> <div class="flex items-center gap-4">`);
    ConnectionStatus($$renderer2);
    $$renderer2.push(`<!----> <span class="text-sm text-gray-600">${escape_html(store_get($$store_subs ??= {}, "$auth", auth).user?.email)}</span> <div class="flex h-8 w-8 items-center justify-center rounded-full bg-gray-200">`);
...
function _layout($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    function $$render_inner($$renderer3) {
      ...
      if (sidebarOpen) {
        $$renderer3.push("<!--[-->");
        $$renderer3.push(`<div class="fixed inset-0 z-40 bg-black/50 lg:hidden" role="button" tabindex="-1"></div>`);
      } else {
        $$renderer3.push("<!--[!-->");
      }
      $$renderer3.push(`<!--]--> `);
      ...
      $$renderer3.push(`<!----> <div class="lg:pl-64">`);
      Header($$renderer3);
      $$renderer3.push(`<!----> <main class="p-6">`);
      children($$renderer3);
